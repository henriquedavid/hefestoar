...
//  private Mesh virtualObjectMesh;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    anchorsByMesh.put(TYPEMESH.CANO, new ArrayList<Anchor>());
    ...
    addButton.setOnClickListener(
            new View.OnClickListener(){
              ...
              public void onClick(View v){
                PopupMenu popup = new PopupMenu(HelloArActivity.this, v);
                popup.setOnMenuItemClickListener(HelloArActivity.this::addMenuClick);
  ...
  /** Menu button to launch feature specific add. */
  protected boolean addMenuClick(MenuItem item) {
    if (item.getItemId() == R.id.pilar) {
        selectedTypeMesh = TYPEMESH.PILAR;
      if(virtualObjectsMesh.get(0) != null)
        selectedVirtualObjectMesh = virtualObjectsMesh.get(0);
      return true;
    } else if (item.getItemId() == R.id.viga) {
        selectedTypeMesh = TYPEMESH.VIGA;
      if(virtualObjectsMesh.get(1) != null)
        selectedVirtualObjectMesh = virtualObjectsMesh.get(1);
      return true;
    } else if (item.getItemId() == R.id.cano){
      selectedTypeMesh = TYPEMESH.CANO;
      return true;
    }
    return false;
  }
  ...
  public void onDrawFrame(SampleRender render) {
    ...
    ArrayList<Anchor> anchors_ = anchorsByMesh.get(selectedTypeMesh);
    ...
    if (tap != null && camera.getTrackingState() == TrackingState.TRACKING) {
      ...
      for (HitResult hit : hitResultList) {
        ...
        if ((trackable instanceof Plane
          ...
          ArrayList<Anchor> listAnchorsSelected = anchorsByMesh.get(selectedTypeMesh);
          listAnchorsSelected.add(hit.createAnchor());
          anchorsByMesh.put(selectedTypeMesh, listAnchorsSelected);
